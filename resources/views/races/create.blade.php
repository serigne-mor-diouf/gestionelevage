    ...
    <div class="container">
        ...
        @if(session('error'))
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('race.create') }}">
                @csrf <!-- Ajoutez le jeton CSRF -->
                <div class="form-box">
                    <h1 id="title">Ajouter une Race </h1>
                    <div class="input-container">
                        <!-- Champs du formulaire avec des icônes Font Awesome -->
                       
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" name="nom" placeholder="Entrez le nom de la race" required value="{{ old('prenom') }}">
                    </div>

                    <div class="input-field">
                        <i class="fas fa-comment"></i>
                        <textarea name="description" placeholder="Entrez votre description">{{ old('description') }}</textarea>
                    </div>
