    ...
    <div class="container">
        ...
        @if(session('error'))
            ...
            <div class="form-container">
                ...
                <div class="form-box">
                    <h1 id="title">Ajouter un client</h1>
                    <div class="input-container">
                        <!-- Champs du formulaire avec des icônes Font Awesome -->
                       
                        <div class="input-field">
                            <i class="fas fa-user"></i>
                            <input type="text" name="nom" placeholder="enter votre nom" required value="{{ old('nom') }}">
                        </div>
                        <div class="input-field">
                            <i class="fas fa-user"></i>
                            <input type="text" name="prenom" placeholder="enter votre prenom"required value="{{ old('prenom') }}">
                        </div>
                        <div class="input-field">
                            <i class="fas fa-lock"></i>
                            <input type="text" name="adresse" placeholder=" entrer votre adresse" value="{{ old('adresse') }}">
                        </div>
                    </div>
                    <div class="btn-field">
