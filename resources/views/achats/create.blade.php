    ...
    <div class="grid-container">
        ...
        @endif
                ...
                <div class="form-container">
                    <form method="POST" action="{{ route('achat.create') }}">
                        @csrf 
                        <div class="form-box">
                            <h1 id="title"> Acheter un mouton</h1>
                            <!-- Section "Achat" -->
                            <div class="input-container">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="text" name="montant" id="montant" placeholder="Entrez le montant de l'achat" required>
                                </div>
                            ...
                            <div class="input-container">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="number" name="montantPaye" id="montantPaye" placeholder="Entrez le montant payé" required>
                                </div>

                                <div class="input-field">
                                    <label for="statutPayement">Statut du paiement</label>
                                    <i class="fas fa-user-friends"></i>
                                    <select id="statutPayement" class="form-control" name="statutPayement">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="date" name="datePayement" id="datePayement" required>
                                </div>
                            </div>
