        ...
        <div class="card" style="width: 50%;">
            ...
            <div class="card-body">
                <form action="{{ route('mouton.update', ['id' => $mouton->id])}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="nomgrandMereMaternelle" class="form-label">Nom grand Mère</label>
                    ...
                    <div class="mb-3">
                        <label for="nomArrieregrandMereMaternelle" class="form-label">Nom Arrière grand Mère Maternelle</label>
