                ...
                <div class="form-box">
                    ...
                    <div class="input-container">
                        ...
                        <div class="input-field" id="nameField">
                            ...
                            <input type="text" name="name" placeholder="Nom" value="{{ old('nom') }}"s>
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="sexe" placeholder="Sexe" value="{{ old('sexe') }}">
                        </div>
                        <div class="input-field">
                    ...
                    <div class="btn-field">
                        ...
                        <button type="submit" class="btn btn-primary" id="signinBtn" class="disable"><a href="/login">Connecter</button></a>
                    </div>
                    @if(session('success'))
                        <div class="bg-green-500 text-green py-2 px-4 rounded-full mb-4">
                        {{ session('success') }}
                    </div>
                    </div>
...
.form-box {
    width: 100%; /* Augmenter la largeur du formulaire */
    max-width: 450px;
    background: #fff;
