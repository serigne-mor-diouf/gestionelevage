...
<br><br>
                ...
                <form action="{{ route('proprietaire.index') }}" method="GET" class="search-form">
                    <div class="relative">
                ...
                @forelse ($proprietaires as $user)
                    <tr>
                        ...
                        <td class="dfg" style="display: flex; justify-content: space-between;">
                            <a href="{{ route('proprietaire.edit', ['id' => $user->id]) }}">
                                <i class="fas fa-edit"></i> 
                            </a>
                            <form action="{{ route('proprietaire.delete', ['id' => $user->id]) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?')">
                                @csrf
                                @method('DELETE')
